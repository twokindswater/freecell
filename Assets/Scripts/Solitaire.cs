...
public class Solitaire : MonoBehaviour
{
    ...
    public static List<string> GeneratreDeck()
    {
    ...
    public void DealFromDeck()
    {
        if (deckLocation < trips)
        {
            ...
            {
                // GameObject newTopCard = Instantiate(cardPrefab, new Vector3(deckButton.transform.position.x + xOffset, deckButton.transform.position.y, deckButton.transform.position.z + zOffset), Quaternion.identity);
            }
        }
    }
}
